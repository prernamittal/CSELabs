...
def index(req):
    ...
    return render(req, 'books.html', {'authors': authors, 
...
def create(req):
    if req.method == 'POST':
        ...
        if not author_form.is_valid():
            return render(req, 'errors.html', {'form': author_form})
        elif not publisher_form.is_valid():
            return render(req, 'errors.html', {'form': publisher_form})
        elif not book_form.is_valid():
            return render(req, 'errors.html', {'form': book_form})
